...
import { Link, withRouter } from "react-router-dom" //we use withRouter to use the history object which allow us to redirect
...
const EditProfile = ({ profile: { profile, loading }, createProfile, history, getCurrentProfile }) => {
    ...
    useEffect(() => {
        getCurrentProfile()
        setFormData({
            //if loading is true or not exist company then it's empty , if loading is false or the company exists then the value of company is that value
    ...
    }, [loading, getCurrentProfile])//that means it will rerun while loading is true and stop if loading is false
    ...
    return (
        ...
        profile stand out
            ...
            HTML,CSS,JavaScript,PHP)</small
                ...
                <div className="my-2">
                    {/*if u click on button and displaySocialInput is false then will be true(wel3aks) */}
